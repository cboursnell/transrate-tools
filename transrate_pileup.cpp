...
// ---------------------------------------------
// TransratePileupPrivate implementation

struct TransratePileup::TransratePileupPrivate {
    ...
    // 'public' methods
    bool AddAlignment(const BamAlignment& al, ref_length);
    void Flush(void);

    vector<int>* getCoverage(void);
...
bool TransratePileup::TransratePileupPrivate::AddAlignment(const BamAlignment& al, int ref_length) {

    // if first time
    if ( IsFirstAlignment ) {
        // create empty coverage array
...
void TransratePileup::TransratePileupPrivate::CalculateCoverage(void) {

    // parse CIGAR data in BamAlignments to build up current pileup data
    CreatePileupData();

    coverage[CurrentPileupData.Position] = CurrentPileupData.PileupAlignments.size();
}

void TransratePileup::TransratePileupPrivate::ClearOldData(void) {
...
void TransratePileup::TransratePileupPrivate::CreatePileupData(void) {
...
void TransratePileup::TransratePileupPrivate::Flush(void) {
    while ( !CurrentAlignments.empty() ) {
        CalculateCoverage();
        ++CurrentPosition;
    }
...
void TransratePileup::TransratePileupPrivate::ParseAlignmentCigar(const BamAlignment& al) {
...
vector<int>* TransratePileup::TransratePileupPrivate::getCoverage() {
    return &coverage;
}

// ---------------------------------------------
// TransratePileup implementation

TransratePileup::TransratePileup(void)
    : d( new TransratePileupPrivate )
{ }
...
bool TransratePileup::AddAlignment(const BamAlignment& al, int ref_length) {
    return d->AddAlignment(al, ref_length);
}

void TransratePileup::Flush(void) { d->Flush(); }

vector<int>* TransratePileup::getCoverage(void) { d->getCoverage(); }
